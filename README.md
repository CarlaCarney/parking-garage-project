...
Diante : Both responsible for breaking out all sections (takeTicket, payForParking, leaveGarage and runParkingGarage), helped drive/write code while Carla and I brainstormed.

Carla : Both responsible for breaking out all sections (takeTicket, payForParking, leaveGarage and runParkingGarage), helped with fixing problem of parking garage resetting each time we ran (used input function to grab name and stored in dictionary to grab when paying)


###### Provide name and approxamite line numbers where each person wrote their code

Both took turns throughout entire code rewriting and fixing bugs in code. Don't have approximate line numbers as both of us worked on every line together.  